...
class ModernDatepicker extends Component {
  ...
  render() {
    ...
    const { defaultDateView, sortHeader, allowEdit, format, placeholder, showBorder, className, id, icon, iconClass, maxDate, minDate, label, labelClass, lang, primaryColor = '#00b9f5', secondaryColor = 'white', primaryTextColor = 'black', secondaryTextColor = 'white' } = this.props;
    const [, isMaxInstanceOfDate, isMinInstanceOfDate] = this.checkDateInstance();
